export default function TopicList({ title, topic_list, handle_select_topic, checkable, default_checked = false })
{
                ...
                {topic_list?.map((topic) =>
                {
                    return checkable ?
                        ...
                        (<div className='flex flex-row space-x-2' key={topic}>
                            <input className={input_style_string} type='checkbox' onChange={() => handle_select_topic(topic)} defaultChecked={default_checked} />
