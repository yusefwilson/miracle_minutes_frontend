    ...
    return (
        <div className='bg-white h-full p-8 space-y-8'>
            <div className='flex flex-col grid justify-items-center p-8 space-y-8'>
                ...
                {logged_in ? <Link className={signup_button_style_string} to='/dashboard/shop'>Upgrade</Link> : <Link className={signup_button_style_string} to='/plans'>Start your free trial now!</Link>}
            </div>
        </div>
    );
}