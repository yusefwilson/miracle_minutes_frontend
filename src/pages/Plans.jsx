...
export default function Plans()
{
    ...
    return (
        <div className='bg-slate-200 flex flex-col items-center h-full p-8 overflow-y-auto scrollbar scrollbar-thumb-rounded-full scrollbar-thumb-gray-400'>
            <div className='flex flex-col gap-4 lg:flex-row lg:h-3/5 w-4/5'>
                ...
                <PlanCard name='Premium' price='4.99' description='Great for those with many interests and a lot of things to learn.' features={['20 topics per month']} id={2}/>
            </div>
        </div>
    );
}