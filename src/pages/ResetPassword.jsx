        ...
        <div className='bg-white flex justify-center h-full grid content-center'>
            <div className='flex flex-col bg-gray-400 p-16 rounded-md shadow-lg'>
                <form className='flex flex-col space-y-2' noValidate onSubmit={handle_submit}>
                    ...
                    <input className='bg-gray-300 rounded h-8 p-4 focus:outline-none' placeholder='Email' onChange={handle_change} name='email' value={email}></input>
                    <input className='bg-gray-300 rounded h-8 p-4 focus:outline-none' placeholder='Code' onChange={handle_change} name='code'></input>
                    <input className='bg-gray-300 rounded h-8 p-4 focus:outline-none' placeholder='New password' onChange={handle_change} name='password'></input>
                    <input className='bg-gray-300 rounded h-8 p-4 focus:outline-none' placeholder='Confirm new password' onChange={handle_change} name='confirmPassword'></input>
