...
export default function Signup()
{
    ...
    //styles
    const login_button_style = 'bg-purple-300 hover:bg-black text-black font-bold py-2 px-4 border-2 border-black hover:border-transparent hover:text-white rounded-full cursor-pointer mx-2';
        ...
        <div className='bg-slate-200 flex justify-center items-center h-full'>
            {
                verify ?
                    ...
                    <form className='bg-gray-400 flex flex-col justify-center p-16 rounded-md shadow-lg border-2 border-black h-4/5 w-2/3 xl:w-1/3 space-y-8' noValidate onSubmit={handle_submit}>
                        ...
                        <button className={login_button_style} type='submit'>Sign up</button>
